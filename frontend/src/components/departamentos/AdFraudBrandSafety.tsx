...
export const AdFraudBrandSafety: React.FC = () => {
  ...
  const cards = [
    ...
    { id: 2, titulo: 'Soluciones de AdFraudBrandSafety', descripcion: 'Técnico IA especializado para MIPYME',                              mediaSrc: '/assets/ciberS/ciberS2.png' },
    ...
    { id: 6, titulo: 'AdFraudBrandSafety Avanzada',      descripcion: 'Supervisión 24/7 con estándares de seguridad avanzada',            mediaSrc: '/assets/ciberS/ciberS6.png' },
  ];
